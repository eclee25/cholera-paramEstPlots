...
## Name: Elizabeth Lee
## Date: 8/21/16
## Function: Export weekly param est data for supplement figures
## Filenames: 
## Data Source: 
## Notes: 
## 8/20/16: JTB_submission2_data
## 
## useful commands:
...
setwd("./JTB_submission2_data/weekly_fits100day_paramEst")
...
write.csv(param.summ, 'weekly_estimate_summary_by_parameters.csv', row.names=F)
write.csv(fitmodel.summ, 'weekly_estimate_summary_by_fittingmodel.csv', row.names=F)
write.csv(param_fitmodel.summ, 'weekly_estimate_summary_by_parameters_and_fittingmodel.csv', row.names=F)
# 8/8/16

#### export cleaned 100d_3y data ################################
write_csv(d6, "weekly_param_est_100d_3y.csv") 
# 8/14/16
