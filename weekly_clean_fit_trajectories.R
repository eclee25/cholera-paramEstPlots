...
## Name: Elizabeth Lee
## Date: 8/21/16
## Function: Clean fit and forecast trajectory data and export (weekly data versions for supplement)
## Filenames: JTB_submission2_data/weekly_fits100day_trajectories, JTB_submission2_data/weekly_forecast_trajectories
## Data Source: 
...
setwd("./JTB_submission2_data/weekly_fits100day_trajectories")
...
# 8/14/16 added
setwd(dirname(sys.frame(1)$ofile))
setwd("./JTB_submission2_data/weekly_fits3yr_trajectories")
...
write_csv(finalDat, "weekly_trajectory_fits_100d.csv") 
write_csv(finalDat3, "weekly_trajectory_fits_3yr.csv")
# 8/21/16
